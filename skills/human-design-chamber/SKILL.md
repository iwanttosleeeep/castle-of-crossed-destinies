...
5. Aim for four to seven useful claims from a rich dossier. Each supplied Type,
   Strategy, Authority, Profile, Definition, Center, or full Channel may support a
   bounded experiment-oriented reading without requiring every advanced layer.
